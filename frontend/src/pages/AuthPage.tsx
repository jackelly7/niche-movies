				...
				body: JSON.stringify({
					...
					...(initialIsLogin
						...
						: {
								...
								disneyPlus:
									streamingServices.includes("Disney+"),
								amazonPrime:
									streamingServices.includes("Amazon Prime"),
								paramountPlus:
									streamingServices.includes("Paramount+"),
								appleTVPlus:
									streamingServices.includes("Apple TV+"),
						...
						<>
							...
							<div>
								...
								<input
									...
									type="email"
									required
									placeholder="example@movies.com"
									value={email}
							...
							<div>
								...
								<input
									...
									type="password"
									required
									placeholder="Must be at least 15 characters long"
									value={password}
									onChange={(e) =>
