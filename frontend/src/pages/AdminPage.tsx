...
const AdminPage = () => {
		...
		async function fetchMovies() {
			try {
				const response = await axios.get(
					"https://niche-movies-backend-new-fhhvc5fsf8hhf0ad.eastus-01.azurewebsites.net/AdminAllMovies",
					{
						params: {
							page,
							pageSize,
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			if (editingMovie) {
				...
				await axios.put(
					`https://niche-movies-backend-new-fhhvc5fsf8hhf0ad.eastus-01.azurewebsites.net/UpdateMovie/${editingMovie.showId}`,
					formData
				);
			} else {
				...
				await axios.post(
					"https://niche-movies-backend-new-fhhvc5fsf8hhf0ad.eastus-01.azurewebsites.net/AddMovie",
					newMovie
				);
			}
	...
	const handleDelete = async (movieId: string) => {
		...
		if (confirm("Are you sure you want to delete this movie?")) {
			try {
				await axios.delete(
					`https://niche-movies-backend-new-fhhvc5fsf8hhf0ad.eastus-01.azurewebsites.net/DeleteMovie/${movieId}`
				);
